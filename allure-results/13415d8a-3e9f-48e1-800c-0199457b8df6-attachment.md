            ...
            - rowgroup [ref=e23]:
              ...
              - row "About Adactin Get solutions for all your testing needs. Visit www.adactin.com today!" [ref=e44]:
                - cell "About Adactin Get solutions for all your testing needs. Visit www.adactin.com today!" [ref=e45]:
                  ...
                  - text: today!
      - row "Search Hotel (Fields marked with Red asterix (*) are mandatory) Location* - Select Location - Hotels - Select Hotel - Room Type - Select Room Type - Number of Rooms* 1 - One Check In Date* 03/04/2026 (dd/mm/yyyy) Check Out Date* 04/04/2026 (dd/mm/yyyy) Adults per Room* 1 - One Children per Room 0 - None Search Reset" [ref=e48]:
        - cell "Search Hotel (Fields marked with Red asterix (*) are mandatory) Location* - Select Location - Hotels - Select Hotel - Room Type - Select Room Type - Number of Rooms* 1 - One Check In Date* 03/04/2026 (dd/mm/yyyy) Check Out Date* 04/04/2026 (dd/mm/yyyy) Adults per Room* 1 - One Children per Room 0 - None Search Reset" [ref=e49]:
          - table [ref=e51]:
            - rowgroup [ref=e52]:
              ...
              - row "Number of Rooms* 1 - One" [ref=e67]:
                ...
                - cell "1 - One" [ref=e69]:
                  - combobox [ref=e70]:
                    ...
                    - option "9 - Nine"
                    - option "10 - Ten"
              - row "Check In Date* 03/04/2026 (dd/mm/yyyy)" [ref=e71]:
                - cell "Check In Date*" [ref=e72]
                - cell "03/04/2026 (dd/mm/yyyy)" [ref=e73]:
                  - textbox [ref=e74]: 03/04/2026
                  - text: (dd/mm/yyyy)
              - row "Check Out Date* 04/04/2026 (dd/mm/yyyy)" [ref=e75]:
                - cell "Check Out Date*" [ref=e76]
                - cell "04/04/2026 (dd/mm/yyyy)" [ref=e77]:
                  - textbox [ref=e78]: 04/04/2026
                  - text: (dd/mm/yyyy)
